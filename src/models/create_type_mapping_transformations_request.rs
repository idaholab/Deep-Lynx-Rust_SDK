...
pub struct CreateTypeMappingTransformationsRequest {
...
impl CreateTypeMappingTransformationsRequest {
    pub fn new(metatype_id: String, conditions: Vec<crate::models::TransformationCondition>, keys: Vec<crate::models::TransformationKey>) -> CreateTypeMappingTransformationsRequest {
