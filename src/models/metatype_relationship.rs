...
pub struct MetatypeRelationship {
    #[serde(rename = "name")]
    pub name: String,
    ...
    pub keys: Option<Vec<crate::models::RelationshipKey>>,
}

impl MetatypeRelationship {
    /// 
    pub fn new(name: String, description: String) -> MetatypeRelationship {
        MetatypeRelationship {
            name,
            description,
            container_id: None,
