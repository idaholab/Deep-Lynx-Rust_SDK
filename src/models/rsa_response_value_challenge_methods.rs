...
pub struct RsaResponseValueChallengeMethods {
    #[serde(rename = "challenges", skip_serializing_if = "Option::is_none")]
    pub challenges: Option<Vec<crate::models::RsaResponseValueChallengeMethodsChallengesInner>>,
}

impl RsaResponseValueChallengeMethods {
    pub fn new() -> RsaResponseValueChallengeMethods {
