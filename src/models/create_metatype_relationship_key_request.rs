...
pub struct CreateMetatypeRelationshipKeyRequest {
    #[serde(rename = "name")]
    pub name: String,
...
impl CreateMetatypeRelationshipKeyRequest {
    pub fn new(name: String, description: String, data_type: String) -> CreateMetatypeRelationshipKeyRequest {
