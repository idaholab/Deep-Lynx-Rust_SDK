...
Put the package under your project folder in a directory named `deeplynx` and add the following to `Cargo.toml` under `[dependencies]`:

```
deeplynx = { path = "./deeplynx" }
```
